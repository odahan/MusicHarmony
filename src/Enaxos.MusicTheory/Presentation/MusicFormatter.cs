...
public static class MusicFormatter
{
    ...
    private static string ScaleName(string id, MusicTerminology terminology)
    {
        ...
        return id switch
        {
            ...
            "scale.exotic.diminished.whole-half" => terminology == MusicTerminology.French ? "octatonique ton-demi-ton" : "octatonic whole-half",
            "scale.exotic.diminished.half-whole" => terminology == MusicTerminology.French ? "octatonique demi-ton-ton" : "octatonic half-whole",
